<x-app-layout>
  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="max-w-2xl py-4 mx-auto">  <x-validation-errors class="mb-4" />
        ...
        <form method="POST" action="{{ route('events.store') }}">
          ...
          <div class="md:flex justify-between items-end">
              <div class="mt-4">
                  <x-label for="max_people" value="重要度" />
